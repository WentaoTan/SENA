...
improved_prompt='''Given the image, the description of the image, a question about the image and the answer, your task is to improve the quality of the answer.
Image Description: <des>
Question: <question>
Current Answer: <answer>
Based on the information provided in the Image Description, please analyze the question further and generate a more precise and concise response.
Your answer should be formatted as:
Improved Answer:
'''

improved_prompt_noDes='''Given the image, the description of the image, a question about the image and the answer, your task is to improve the quality of the answer using a single word or phrase.
Question: <question>
Current Answer: <answer>
Please analyze the question further and generate a more precise and concise response.
Your answer should be formatted as:
Improved Answer:
'''
...
def main(args):
    ...
    for line in tqdm.tqdm(lines[start:end]):
        ...
        if False:
            ...
            if data['des'] == 'Yes' or data['des'] == 'yes':
                message_input = improved_prompt_noDes.replace('<question>',data['question']).replace('<answer>',data['answer'])
            else:
                message_input = improved_prompt.replace('<des>',data['des']).replace('<question>',data['question']).replace('<answer>',data['answer'])
            # message_input = improved_prompt.replace('<des>',des).replace('<question>',data['question']).replace('<answer>',data['answer'])
            image = data["image"]
            ...
            if outputs.startswith('Improved Answer:'):
                outputs = outputs.replace('Improved Answer: ','')
                data['answer'] = outputs
                results.append(data)
            else:
                results.append(data)
